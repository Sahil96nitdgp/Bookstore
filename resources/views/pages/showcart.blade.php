            ...
            @foreach($results as $result)
                <div class="well well-sm">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <h2><a href="/iandwe/public/books/{{$result->book_id}}">{{$result->title}}</a>
                        ...
                        <div class="col-md-2">
                            ...
                            <button class="btn btn-danger btn-lg"><a href="/iandwe/public/home/removecart/{{$result->book_id}}" style="color :cornsilk">Remove From Cart</a></button>
                        </div>
                    </div>
                </div>
            @endforeach
